...
public class CurrencyConverter {
    ...
    static {
        ...
        exchangeRates.put("PLN_GBP", 0.19);
        exchangeRates.put("EUR_PLN", 4.50);
        exchangeRates.put("EUR_GBP", 0.86);
        exchangeRates.put("GBP_PLN", 5.30);
    ...
    public static double convertCurrency(String fromCurrency, String toCurrency, double amount) {
        ...
        if (!exchangeRates.containsKey(key)) {
            throw new IllegalArgumentException("Exchange rate not available for: " + fromCurrency + " to " + toCurrency); // TODO different exception
        }
